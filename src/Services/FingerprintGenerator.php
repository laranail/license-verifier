...
class FingerprintGenerator
{
    ...
    {
        // Only stable, machine-bound components — PHP/Laravel versions are
        // deliberately excluded so a routine runtime upgrade does not change the
        // fingerprint and self-invalidate an offline activation.
        $components = [
            $this->getHostname(),
            $this->getMachineId(),
            $this->getAppKey(),
